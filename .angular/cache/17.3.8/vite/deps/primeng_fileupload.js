...
import {
  DomSanitizer
} from "./chunk-CS3EUUUX.js";
import {
  HttpClient,
  HttpEventType
} from "./chunk-CB3CDQYP.js";
import {
  Button,
  ButtonDirective,
  ButtonModule
...
var FileUpload = class _FileUpload {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    inputs: {
      ...
      fileLimit: [InputFlags.HasDecoratorInputTransform, "fileLimit", "fileLimit", (value) => numberAttribute(value, null)],
